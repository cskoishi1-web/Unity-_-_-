Shader "Hidden/ltspass_transparent" {
	Properties {
		...
		_OutlineSrcBlend ("", Float) = 5
		_OutlineDstBlend ("", Float) = 10
		...
		_PreColor ("", Vector) = (1,1,1,1)
		_PreOutType ("", Float) = 0
		_PreCutoff ("", Range(-0.001, 1.001)) = 0.5
		_PreCull ("", Float) = 2
		_PreSrcBlend ("", Float) = 1
		_PreDstBlend ("", Float) = 10
		_PreSrcBlendAlpha ("", Float) = 1
		_PreDstBlendAlpha ("", Float) = 10
		_PreBlendOp ("", Float) = 0
		_PreBlendOpAlpha ("", Float) = 0
		_PreSrcBlendFA ("", Float) = 1
		_PreDstBlendFA ("", Float) = 1
		_PreSrcBlendAlphaFA ("", Float) = 0
		_PreDstBlendAlphaFA ("", Float) = 1
		_PreBlendOpFA ("", Float) = 4
		_PreBlendOpAlphaFA ("", Float) = 4
		_PreZClip ("", Float) = 1
		_PreZWrite ("", Float) = 1
		_PreZTest ("", Float) = 4
		...
		_PreColorMask ("", Float) = 15
		_PreAlphaToMask ("", Float) = 0
	}
