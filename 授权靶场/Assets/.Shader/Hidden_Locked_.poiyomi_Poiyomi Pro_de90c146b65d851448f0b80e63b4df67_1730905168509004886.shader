Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/de90c146b65d851448f0b80e63b4df67_1730905168509004886" {
	Properties {
		...
		[Helpbox(1, 2, 1)] _UDIMDiscardHelpbox ("UV Tile Discard requires special model setup. Click for Tutorial on the Documentation.--{onClick:{type:URL,data:https://www.poiyomi.com/special-fx/uv-tile-discard#uv-tile-setup}}", Float) = 0
		...
		[Space(7)] [DoNotAnimate] [ThryMultiFloatHeaderDrawer(Column 0, Column 1, Column 2, Column 3)] _UDIMDiscardHeader ("UDIM", Float) = 0
		...
		[Space(7)] [ThryMultiFloatHeaderDrawer(Column 0, Column 1, Column 2, Column 3)] _FaceDiscardHeader ("UDIM", Float) = 0
